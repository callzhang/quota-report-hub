...
// What the user-facing notices tell people to switch to: the nearest-capability models that do NOT
// count toward the premium share. A test asserts these are actually non-premium -- copy that
// recommends a model which itself blows the budget is worse than no advice at all.
export const SUGGESTED_STANDARD_MODEL_IDS = Object.freeze([
  "gpt-5.6-terra",
  "claude-sonnet-5",
]);
