...
// race with itself.
//
// 2.4.0 is also the first client that cannot charge a cumulative counter as fresh usage, and the
// first whose heartbeat says whether its own updater is working.
export const MIN_REPORTER_CLIENT_VERSION = "2.4.0";
