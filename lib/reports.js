...
// a clock, so a stale value in the past is inert by construction. Only strings are accepted:
// Date.parse of a coerced number reads it as a calendar year (3600 -> year 3600), so a plausible
// client bug — sending a duration instead of a timestamp — must fail closed to null, not become a
// multi-century future deadline.
