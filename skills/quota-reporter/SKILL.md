...
4. Reads local Claude CLI auth and usage metadata when Claude is present, and probes `anthropic-ratelimit-unified-*` response headers for `5H` / `1week` windows when bearer auth is available
